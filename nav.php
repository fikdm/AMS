<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li ><a href="add-asset.php">Asset Acquirement</a></li>
      <li><a href="list.php">Asset Inquery</a></li>
      <li class="dropdown">
        <a class="dropdown-toggle" data-toggle="dropdown" href="#">Log
        <span class="caret"></span></a>
        <ul class="dropdown-menu">
          <li><a href="item-log.php">Item Log</a></li>
          <li><a href="user-log.php">User Log</a></li>
        </ul>
      </li>
      <li class="dropdown">
