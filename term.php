...
<div class="container">
  <h2>Terminate</h2>
<?php 
//if(no of item > 0){ input number form exist
// no_item-inputnumb=no_item
// old id and no item(status 1)
// new id and inputnumb(status 3)--copy from above with desc_out comment
}else {
// old id and no_item(status 3)--with desc_out comment
}
